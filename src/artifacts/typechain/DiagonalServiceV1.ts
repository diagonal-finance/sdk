...
import {
  ...
  export interface DiagonalServiceV1Interface extends utils.Interface {
    ...
    getEvent(nameOrSignatureOrTopic: "EmergencyCloseSubscription"): EventFragment;
  ...
  export interface DiagonalServiceV1 extends BaseContract {
    ...
    ownerFlowRates(token: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    callStatic: {
      ...
      activatePackage(id: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
      ...
      PackageStopped(packageId?: BigNumberish | null): PackageStoppedEventFilter;
  
      "PrimaryTokenAdded(address)"(
        superToken?: string | null
      ): PrimaryTokenAddedEventFilter;
      PrimaryTokenAdded(superToken?: string | null): PrimaryTokenAddedEventFilter;
    ...
    estimateGas: {
      ...
      primaryTokens(token: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
      DIAGONAL_REGISTRY(overrides?: CallOverrides): Promise<PopulatedTransaction>;
